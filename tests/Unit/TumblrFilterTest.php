...
class TumblrFilterTest extends TestCase
{
    ...
    /** @test */
    public function it_filters_video_posts_into_organized_structure()
    {
        $last_scrapped_time = now()->subMonth();

        $filter = new TumblrFilter($last_scrapped_time, $this->getVideoPosts());

        $videos = $filter->getFilteredVideos($this->filteredVideoPosts());

        $this->assertCount(2, $videos);

        $this->assertEquals([
            'video_url' => "https://vtt.tumblr.com/tumblr_p7ovqqG3Hf1wko1v2.mp4",
            'thumbnail_url' => "https://78.media.tumblr.com/tumblr_p7ovqqG3Hf1wko1v2_frame1.jpg",
            'thumbnail_width' => 360,
        ...
        $this->assertEquals([
            'video_url' => "https://vtt.tumblr.com/tumblr_owbi4fuRkL1wte8b1.mp4",
            'thumbnail_url' => "https://78.media.tumblr.com/tumblr_owbi4fuRkL1wte8b1_frame1.jpg",
            'thumbnail_width' => 626,
    ...
    private function filteredVideoPosts()
    {
        return json_decode('[
                {
                    "type": "video",
                    "timestamp": 1534087908,
                    "video_url": "https://vtt.tumblr.com/tumblr_p7ovqqG3Hf1wko1v2.mp4",
                    "thumbnail_url": "https://78.media.tumblr.com/tumblr_p7ovqqG3Hf1wko1v2_frame1.jpg",
                    "thumbnail_width": 360,
                    "thumbnail_height": 640,
    ...
    private function getVideoPosts()
    {
        return [
            'posts' =>
                array(
